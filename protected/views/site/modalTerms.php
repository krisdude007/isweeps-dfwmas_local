...
<p>
   ...
   This Sweepstakes is offered and open to persons who are: (a) Registered Participants through the Website; (b) legal residents of United States; and (c) at least 18 years of age on date of entry into a Sweepstakes and the age of majority in entrant’s local jurisdiction.  Employees and directors, and their immediate family members, of the Sweepstakes Entities, advertising and promotion agencies and legal and financial advisors are not eligible to participate in the Sweepstakes.  For purpose of the foregoing, "immediate family" means parents, spouses, children, siblings or any members of the same households of such employees and directors.  For purposes of these Terms/Official Rules, "Participant" means a person who has successfully completed the registration form by registering a valid e-mail and associated password on the Website.  There is no fee or charge to become a Registered Participant.  Sweepstakes void where prohibited. 
</p>
<p>
...
Redeem Game Credits to obtain Sweepstakes Game Entries.  Each Sweepstakes Game Entry submitted during the Promotion Period contains the stated number of entries as well as the opportunity to obtain bonus entries by correctly answering the stated number of questions.  

</p>
<p>
    <strong>5. Sweepstakes Game Piece Rules:</strong>
   As defined by the rules of the game each contest entered will count towards the number of entries specified by that contest into the Sweepstakes.  Any failed attempts to answer, failing to answer a question in the time allotted, closing of browsers, or any technical errors with access points or devices, will not count towards a sweepstakes entry. Number of questions and number of sweepstakes entries associated with said questions are set by the Sweepstakes Operator and detailed in the “Rules” link/section. The source of the correct answer to the questions will be from reliable third parties.  Sweepstakes Operator and Software Provider are not held responsible for this and any third-party content used to answer the questions.  In the event a question cannot be answered then all answers to that question will be considered as correct. 
</p>
<p>
...
<p>
    ...
    All federal, state, local and other tax obligations arising from this Promotion, including, without limitation, winning a Prize, will be the sole responsibility of each Prize winner.  The Sweepstakes Entities, and their parents, affiliated and subsidiary companies and advertising and promotion agencies assume no liability and are not responsible for, and Participant hereby forever waives any rights to any claim in connection with, the selection and announcement of a Prize winner, the distribution of a Prize, the acceptance/possession and/or use/ misuse of any part of a Prize and/or any injury or damage to any Participant's or third person's property related to or resulting from any part of a Prize or any part of this Promotion.  No assignment, transfer, conversion to cash or cash redemption or substitution of a Prize is permitted, except Provider reserves the right to substitute any Prize with a prize of comparable or greater value should a Prize become unavailable.  Prize is solely for Prize winner's use and may not be used in conjunction with any other promotion.  All other costs and expenses not specified herein, if any, are the responsibility of each Prize winner.  All Prize details are at the sole discretion of the Provider. 

</p>
<p>
    <strong>9. Odds/Drawings/Winner Notification:</strong>
    Odds of winning depend on the number of eligible entries received during the Promotion Period and are equal regardless of method of entry or source of credits.  Contribution does not improve odds of winning.  Prize drawings will be conducted at random by Provider, whose decisions are final and binding in all respects. Potential Prize winners will be notified by email and/or by phone.  If a potential Prize winner cannot be reached after a reasonable effort has been made during five (5) business days from the first notification attempt, such person may be disqualified, with an alternate Prize winner selected in accordance with these Official Rules.  Only one attempt for a new alternate will be conducted per Prize.  If attempts fail, unclaimed Prize(s) will not be awarded.
</p>
<p>
    <strong>
        10. Affidavit of Eligibility/Liability Release and Publicity Release:
    </strong>
    Potential Prize winners will be required to complete, execute, and return an Affidavit of Eligibility/Liability Release, and where lawful, a Publicity Release (collectively, the "Release Forms") within five (5) days of notification of winning.  Failure to return Release Forms in a timely manner, or if a Prize notification or a Prize is returned as non- deliverable, or if a Prize winner is found not to be eligible or not in compliance with these Official Rules, may result in disqualification with an alternate Prize winner selected in accordance with these Official Rules.
</p>
<p>
    <strong>11. Publicity Release Terms:</strong>
   : Except where prohibited by law, a Prize winner's acceptance of a Prize constitutes permission for the Sweepstakes Entities to use a Prize winner's name, photograph, likeness, statements, biographical information, voice, and address (city and state) worldwide and in all forms of media, in perpetuity, without further compensation.  Moreover, by entering these Sweepstakes, unless prohibited by law, the potential Prize Winner agrees to grant to the Sweepstakes Providers, and their respective licensees, affiliates, and assigns, the right to print, publish, broadcast, and use, worldwide in any media now known or hereafter developed, including without limitation the Internet, at any time or times, the Prize Winner’s respective name, likeness (actual or simulated), voice (actual or simulated), and biographical information as news or information and for advertising and promotional purposes without additional consideration; and further without such additional compensation, appear for, or provide biographical information for use in, any presentation or other activity which may include filming/audio/video/electronic or other recordings and/or interviews, as may be determined from time to time by the Sweepstakes Providers in its sole discretion.
</p>
<p>
    <strong>12. Breach of Terms:</strong>
    Operator may refuse game play if it is believed participant is in breach of any of the Terms of this Agreement, including but not limited to, where Operator believes that Participant is underage; is involved in fraud, money laundering, collusion, match rigging or cheating of any kind; Participant is trying to use Operator’s products or services from a restricted territory; is playing in contravention of the laws in Participant’s place of residence.  In addition, any such breach will be regarded as a material breach and entitle Operator to terminate this Agreement with Participant immediately. Operator, at its sole discretion, may disqualify any Participant from participation in or use of any or all portions of this Promotion, and refuse to award a Prize or any part of a Prize, if Participant engages in any conduct Operator deems to be improper, unfair or otherwise adverse to the operation of the Promotion or detrimental to other Participants of the Promotion.  Such improper conduct includes, without limitation, falsifying personal information required during Participant registration or Prize claim, violating any term or condition stated herein, accumulating entries through methods such as automated computer scripts or any other programming techniques, allowing others to use Participant's personal information for the purpose of accumulating entries, or intentionally trying to defraud, reverse engineer, disassemble or otherwise tamper with the computer programs in connection with this Promotion.  Participants agree that Operator may void any part of a Prize that Participant may have won and/or require the return of any part of a Prize that Participant may have won as a result of such improper conduct. Participant further acknowledges that any forfeiture of a Prize and/or return of a Prize shall in no way prevent Administrator from pursuing other avenues of recourse such as criminal or civil proceedings in connection with such conduct. WARNING: ANY ATTEMPT TO DELIBERATELY DAMAGE OR UNDERMINE THE LEGITIMATE OPERATION OF THIS PROMOTION MAY BE A VIOLATION OF CRIMINAL AND CIVIL LAWS AND SHOULD SUCH AN ATTEMPT BE MADE, EACH OF THE SWEEPSTAKES ENTITIES RESERVES THE RIGHT TO SEEK DAMAGES OR OTHER REMEDIES FROM ANY SUCH PERSON(S) RESPONSIBLE FOR SUCH ATTEMPT TO THE FULLEST EXTENT PERMITTED BY LAW.

</p>
<p>
    <strong>13. Payment Issues:</strong>
...
<p>
    ...
    Please contact
    <a href="mailto:support@isweepsusa.com">
