                ...
                <div class="table-responsive">
                    <table class="table table-bordered" style="background-color: #eeeeee; border: 1px solid #eeeeee;">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; ?>
                            <?php if ($i == 0): ?>
                                <tr><td colspan="5" style="text-align: center; border: 1px solid #eeeeee;"><?php echo Yii::t('youtoo','PLEASE COME BACK TO SEE THE SWEEPSTAKES WINNERS LIST NEXT WEEK. THANKS'); ?></td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
