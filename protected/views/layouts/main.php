    ...
    <div class="main">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-left">
                <li class="logo"><a target="_blank" href="http://baldinis.net/"><img src="/webassets/images/laliga/logo_Azteca.png" style="height: 40px; position: relative; top: -6px; z-index: 1040; margin-left: 5px;"/></a></li>
